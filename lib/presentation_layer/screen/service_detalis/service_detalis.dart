...
import 'package:clean_app/presentation_layer/screen/service_detalis/service_detalis_controller.dart';
...
class ServiceDetalisScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ServiceDetalisController service = Get.put(ServiceDetalisController());
    return Scaffold(
      ...
      body: GetBuilder<ServiceDetalisController>(
        builder: (controller) {
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Text(
                                        controller.singleService?.data!.title ??
                                            "تنظيف شركات",
